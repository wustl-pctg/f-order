...
int  mat_mul_par(const REAL *const A, const REAL *const B, REAL *C, cilk::future<int> *CReady, int n);
...
int  mat_mul_par(const REAL *const A, const REAL *const B, REAL *C, cilk::future<int> *CReady, int n){
    ...
    cilk::future<int> stages[4];// = new cilk::future<void>[4];
    ...
    reasync_helper(&stages[0], mat_mul_par, A1, B1, C1, CReady, n>>1);
    ...
    reasync_helper(&stages[1], mat_mul_par, A1, B2, C2, CReady, n>>1);
    ...
    reasync_helper(&stages[2], mat_mul_par, A3, B1, C3, CReady, n>>1);
    ...
    reasync_helper(&stages[3], mat_mul_par, A3, B2, C4, CReady, n>>1);
