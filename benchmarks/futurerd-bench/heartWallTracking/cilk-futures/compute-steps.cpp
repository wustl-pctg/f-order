...
void __attribute__((constructor)) print_type() {
        ...
        printf("Using structured futures\n");
    #endif
...
void __attribute__((noinline)) compute_kernel(const public_struct *pub, private_struct *priv) {
    ...
    if(pub->frame_no == 0) {
        ...
        s1 = cilk_spawn compute_step1(pub, priv);

        s9 = cilk_spawn compute_step9(pub, priv);
        ...
        s4 = cilk_spawn compute_step4(pub, priv);
        ...
        s7 = cilk_spawn compute_step7(pub, priv);
        s6 = compute_step6(pub, priv);
...
void __attribute__((noinline)) compute_kernel(const public_struct *pub, private_struct *priv) {
    ...
    if(pub->frame_no == 0) {
        ...
        cilk_future_create1(&fhandles[1], compute_step2, pub, priv);

        new (&fhandles[0]) cilk::future<int>();
        //START_FUTURE_SPAWN;
        //    compute_step1_helper(&fhandles[0], pub, priv);
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[0], compute_step1, pub, priv);

        new (&fhandles[8]) cilk::future<int>();
        //START_FUTURE_SPAWN;
        //    compute_step9_helper(&fhandles[8], pub, priv);
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[8], compute_step9, pub, priv);
        ...
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[2], compute_step3, pub, priv);
        ...
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[3], compute_step4, pub, priv);
        ...
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[6], compute_step7, pub, priv);
        ...
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[5], compute_step6, pub, priv);
        ...
        //END_FUTURE_SPAWN;
        cilk_future_create1(&fhandles[7], compute_step8, pub, priv);
...
typedef void (*compute_helper_func_ptr_t) (cilk::future<int> *, const public_struct *, private_struct *, cilk::future<int> *, int);
...
void __attribute__((noinline)) compute_kernel(const public_struct *pub, private_struct *priv) {
    ...
    if(pub->frame_no == 0) {
        ...
        //  cilk::future<int> *f = &fhandles[i];
          ...
          //END_FUTURE_SPAWN;
        //}
        cilk_future_create1(&fhandles[0], compute_step1_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[1], compute_step2_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[2], compute_step3_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[3], compute_step4_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[4], compute_step5_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[5], compute_step6_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[6], compute_step7_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[7], compute_step8_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[8], compute_step9_with_get, pub, priv, fhandles, frame_no); 
        cilk_future_create1(&fhandles[9], compute_step10_with_get, pub, priv, fhandles, frame_no); 
